...
#define kDrugDetail @"http://phone.lkhealth.net/ydzx/business/apppage/druginfo.html?&drugid=%@"

@interface DrugDetailController ()<UIWebViewDelegate>
...
- (void)getData{
    ...
    NSString *urlStr = [NSString stringWithFormat:kDrugDetail,self.myId];
