...
#define kBigDisOne @"http://api.lkhealth.net/index.php?r=drug/rareDisease"

@interface BigDisController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BigDisController

- (void)viewDidLoad {
    [super viewDidLoad];

    self.navigationItem.title = @"大病罕见病";
...
- (void)getTableViewData{
    ...
    [DataTool solveDataWithUrlStr:kBigDisOne method:@"GET" postBody:nil sloveBlock:^(id obj) {
        
        NSDictionary *dict = (NSDictionary *)obj;
        NSArray *list = dict[@"data"][@"rareDiseaseList"];
